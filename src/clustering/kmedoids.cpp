 ...
 ******************************************************************************/
 ...
 public:
   ...
   set<string>
   get_medoid_members(const string medoid) const {
     set<string> res;
    ...
    */
   string
   get_cluster_assignment(const string &instance_name) const {
    ...
    */
   double
   compute_membership_probability(const string &instance,
    ...
    */
   string
   find_closest_medoid(const string &instance_name) {
    ...
    */
   double
   get_distance(const string &s, const string &t) const {
     if (s == t) return 0;
 ...
 private:
   ...
   bool
   is_medoid(const string &id) const {
    ...
    */
   void
   swap_medoid(const string &non_medoid, const string &medoid) {
    ...
    */
   void
   assign_to_medoid(const string &instance, const string medoid) {
